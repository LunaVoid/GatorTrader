export const signUp = async function (userData) {
    ...
    try{
        const response = await fetch("https://gatortrader.lunael.org/api/signup",{
            method: "POST",
            headers: {
...
export const logIn = async function (userData) {
    try{
        ...
        const response = await fetch("https://gatortrader.lunael.org/api/login",{
            method: "POST",
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
...
export const sendPhoto = async function (image, token) {
    try{
        ...
        const response = await fetch("https://gatortrader.lunael.org/api/profileupdate", {
            method: "POST",
            headers: {
...
export const getPhoto = async function (token) {
    try{
        const response = await fetch("https://gatortrader.lunael.org/api/getProfile", {
            method: "GET",
            headers: {
                'Authorization':token, // JWT token can go in headers
                // Don't set Content-Type header - FormData will set it automatically
...
export const setEmail = async function(email, token){
    try{
        const response = await fetch("https://gatortrader.lunael.org/api/changeemail", {
            method: "POST",
            headers: {
                'Authorization':token,
                'Content-Type': 'application/json',
...
export const getLevel = async function (token) {
    try{
        const response = await fetch("https://gatortrader.lunael.org/api/getLevel", {
            method: "GET",
            headers: {
                'Authorization':token, // JWT token can go in headers
                // Don't set Content-Type header - FormData will set it automatically
...
export const setLevel = async function (token, level) {
    try{
        const response = await fetch("https://gatortrader.lunael.org/api/changeLevel", {
            method: "POST",
            headers: {
                'Authorization':token, 
                'Content-Type': 'application/json',
...
export const setFavs = async function (token, favStocks) {
    try{
        const response = await fetch("https://gatortrader.lunael.org/api/setfavs", {
            method: "POST",
            headers: {
                'Authorization':token, 
                'Content-Type': 'application/json',
...
export const getFavs = async function (token) {
    try{
        const response = await fetch("https://gatortrader.lunael.org/api/getfavs", {
            method: "GET",
            headers: {
                'Authorization':token, // JWT token can go in headers
                // Don't set Content-Type header - FormData will set it automatically
